package jp.ac.asojuku.st.myrolingball
...
import jp.ac.asojuku.st.myrolingball.R
import jp.ac.asojuku.st.myrolingball.R.id.surfaceView
...
class MainActivity : AppCompatActivity(), SensorEventListener,SurfaceHolder.Callback{
    ...
    // 障害物
    private var rectL:Float = 500f;
    private var rectT:Float = 500f;
    private var rectR:Float = 900f;
    private var rectB:Float = 680f;
...
//            }
    ...
    private fun drawCanvas(){
        ...
        canvas.drawCircle(ballX, // x座標
                ballY, // y座標
                (radius*1.02f), // 半径
                Paint().apply{color = Color.BLUE}); // 色
    // 障害物の四角
